namespace projeto_ferramentaria
{
    partial class areasCsn
    {
        ...
        private void InitializeComponent()
        {
            ...
            // enviarButton
            // 
            enviarButton.Location = new Point(345, 270);
            enviarButton.Name = "enviarButton";
            enviarButton.Size = new Size(142, 34);
            ...
            label1.Location = new Point(173, 179);
            label1.Name = "label1";
            label1.Size = new Size(207, 30);
            label1.TabIndex = 2;
            label1.Text = "Digite a area da csn:";
            // 
            // label2
            // 
            label2.AutoSize = true;
            label2.Font = new Font("Segoe UI", 16F);
            label2.Location = new Point(333, 57);
            label2.Name = "label2";
            label2.Size = new Size(145, 30);
            label2.TabIndex = 3;
            label2.Text = "Areas da CSN";
            // 
            // textBox1
            // 
            ...
            textBox1.PlaceholderText = "digite a area da csn...";
