...
namespace listar_banco
{
    public partial class Form1 : Form
    {
        ...
        private int id_contato_selecionado;
        public Form1()
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "Update contato SET nome_contato=@nome, email=@email, telefone=@telefone WHERE id_contato=@id";
                ...
                //sempre apos os paramentros
                cmd.ExecuteNonQuery();

                //maneira mais bonita de limpar os textBox apos o uso
                textBox2.Clear();
                textBox3.Clear();
                textBox4.Clear();
                MessageBox.Show("Id selecionado = " + id_contato_selecionado, "Erro", MessageBoxButtons.OK, MessageBoxIcon.Information);
                carregar_contatos();
        ...
        private void toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DialogResult conf = MessageBox.Show("tem certeza que deseja apagar este dado? ","DELETANDO",MessageBoxButtons.YesNo,MessageBoxIcon.Exclamation);

                if (conf == DialogResult.Yes)
                {
                    cmd.CommandText = "DELETE FROM contato WHERE id_contato=@id";
                    ...
                    cmd.ExecuteNonQuery();
                    MessageBox.Show("deletando item id = " + id_contato_selecionado, "apagando", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
